...
#define HOSTNAME STUDENT_USER

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = STUDENT_USER;
//Contraseña de MQTT que recibió por correo
const char MQTT_PASS[] = STUDENT_CODE;
const char MQTT_SUB_TOPIC[] = HOSTNAME "/";
//Tópico al que se enviarán los datos de humedad
const char MQTT_PUB_TOPIC1[] = "humedad/" + String(STUDENT_CITY) + String(STUDENT_USER);
//Tópico al que se enviarán los datos de temperatura
const char MQTT_PUB_TOPIC2[] = "temperatura/" + String(STUDENT_CITY) + String(STUDENT_USER);
//Tópico al que se enviarán los datos de luminosidad
const char MQTT_PUB_TOPIC3[] = "luminosidad/" + String(STUDENT_CITY) + String(STUDENT_USER);
...
void loop()
{
  ...
  // Lectura sensor DHT 11
  float h = dht.readHumidity();
  float t = dht.readTemperature();

  // LDR Sensor LDR
  ldr = analogRead (LDRPIN);  // Read sensor input
